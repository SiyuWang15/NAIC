...
if use_gpu:
    ...
    SD_path = '/home/hjiang/AI second part/Modelsave0_p'+str(Pilot_num)+'/Rhy5_f4_cpu'
    SD = pD.DeepRx(SD_path,cuda_gpu=False,gpus=[0,1])    
...
with torch.no_grad():
    ...
    for idx in range(N):
        ...
        if use_gpu:
            ...
            output3 = pD.Pred_DeepRX(SD, torch.reshape(H_test_padding, [-1, 2,2,2,256]), Yd_input_test)
        print('第三层')
